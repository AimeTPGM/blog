...
{% include file-name.html content="อันนี้เป็นชื่ือไฟล์ข้างบนโค้ดด้วย file-name.html" %}
...
ทั้ง signature ด้านล่างทุก entry, สารบัญลิ้งด้วยบน, หรือลิ้งไปอ่าน EP อื่นใน series เดียวกันของบล็อกนี้ ก็ล้วนเขียนเป็น component ไว้ใน `_includes` ทั้งสิ้น {% include low-focus-text.html content="[เข้าไปดู sourcecode จิ้มจ้า](https://github.com/AimeTPGM/blog)" %}
...
สำหรับ seires ทำ Blog ด้วย Jekyll ตั้งใจจะเขียนเนื้อหาหลักไว้แค่ 4 Parts ที่เหลือจะเป็น Spin-off หมดและ
