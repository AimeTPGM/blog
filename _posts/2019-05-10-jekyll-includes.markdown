...
ทั้ง signature ด้านล่างทุก entry, สารบัญลิ้งด้านบน (Entry นี้มีอะไรบ้าง), หรือลิ้งไปอ่าน EP อื่นใน series เดียวกันของบล็อกนี้ ก็ล้วนเขียนเป็น component ไว้ใน `_includes` ทั้งสิ้น {% include low-focus-text.html content="[เข้าไปดู sourcecode จิ้มจ้า](https://github.com/AimeTPGM/blog){:target='_blank'}" %}
